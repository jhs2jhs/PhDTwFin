...
db_path = './tweets/tweet_tingbrokers.db'
...
'''
def tw_tingbrokers_init(file_source, tw_type):
...
if __name__ == "__main__":
    db_init()
    input_file_path = './tweets/ting_brokers.txt'
    tw_tingbrokers_init(input_file_path, tw_type_tingbrokers)
